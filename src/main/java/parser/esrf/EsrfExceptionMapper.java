...
public final class EsrfExceptionMapper implements ResponseExceptionMapper<EsrfException> {

    private static final Logger log = Logger.getLogger(EsrfExceptionMapper.class);
